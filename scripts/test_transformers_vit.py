...
def main():
    ...
    caps_imgs = load_images_folder(caps_path)[:10]
    caps_filenames = get_filenames(caps_path)[:10]
    streams_imgs = load_images_folder(streams_path)[:10]
    streams_filenames = get_filenames(streams_path)[:10]
